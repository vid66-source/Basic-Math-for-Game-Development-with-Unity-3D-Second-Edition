...
public class EX_6_2_MyScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ShowOppPlane = new MyXZPlane
        {
            PlaneColor = new Color(0.2f, 0.5f, 0.8f, 1.0f),
            XSize = 0.5f,
            YSize = 0.5f,
            ZSize = 0.5f
        };
    ...
    void Update()
    {
        ...
        Pd.transform.localPosition = D * - vn;
        ...
        ShowOppNormal.VectorAt = Vector3.zero;
        ShowOppNormal.Magnitude = Mathf.Abs(D)+2f;
        ShowOppNormal.Direction = -vn;

        ShowPlane.PlaneNormal = -vn;
        ShowOppPlane.PlaneNormal = vn;
        ...
        ShowOppPlane.XSize = ShowOppPlane.ZSize = du;
        ShowOppPlane.Center = Pd.transform.localPosition;
        #endregion
